 ...
 public static void main(String args[]) throws SQLException
  {
	...
	try{
	    ...
	    createUser(1);          // try to create user that already exists
	    ...
	    System.out.println("Selecting new group:");  
	    ...
	    System.out.println("Sending message from Joe Lynch to Kalyn Sigg");
	    ...
	    System.out.println("Searching for: zq");
	    searchForUser(1);       // search for email
	    ...
	    System.out.println("Drop Zachary Quinto");
